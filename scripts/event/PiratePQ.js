...
function playerEntry(eim, player) {
	var map = eim.getMapInstance(925100100);
...
function clearPQ(eim) {
	end(eim, "Congratuations! You cleared the PQ.");
}
...
function timeOut() {
	var eim = em.getInstance("PiratePQ_" + channel);
