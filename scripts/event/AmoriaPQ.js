 ...
 */
 ...
 function setup(eim) {
	...
	var instanceName = "AmoriaPQ" + channel;
	...
	eim.setProperty("isatbonus", "false");
...
function playerRevive(eim, player) {
	if (eim.getProperty("isatbonus") == "true")
	{
...
function clearPQ(eim) {
	eim.setProperty("isatbonus", "true");
	...
	while (iter.hasNext()) 
	{
		...
		pqCheck.addOrUpdatePQ(player, "AmoriaPQ");

		player.message("Do not hit the same boxes as someone else or else everyone may disconnect in the map.");
