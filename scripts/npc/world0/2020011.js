...
function action(mode, type, selection){
    ...
    if (actionx["Mental"]){
        if (status == 0)
            ...
            //Need thieves text.
            cm.sendNext("You're #b" + (job == 411 ? "Hermit" : "Chief Bandit") + "#k from here on out. May #rOdin#k be with you!");
        } else if (status == 3) {
        ...
        cm.sendOk("Go, talk with #b#p1052001##k and bring me #b#t4031057##k.");
        cm.dispose();
