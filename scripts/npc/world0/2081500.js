...
function action(mode, type, selection) {
    if (mode >= 1 && cm.getJobId() % 100 % 10 != 2) {
		...
		if(cm.getJobId() == 512) 
		{
			...
			if(cm.getPlayer().getSkillLevel(5121001) == 0)
				cm.teachSkill(5121001, 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(5121002) == 0)
				cm.teachSkill(5121002, 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(5121007) == 0)
				cm.teachSkill(5121007, 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(5121009) == 0)
