...
//** Pirate 3rd Job Instructor Pedro
...
function action(mode, type, selection){
    ...
    if (actionx["Mental"]){
        if (status == 0)
            ...
            cm.sendNext("You're #b" + (job == 511 ? "Marauder" : "Outlaw") + "#k from here on out. May #rOdin#k be with you!");
        } else if (status == 3) {
        ...
        cm.sendOk("Go, talk with #b#p1090000##k and bring me #b#t4031057##k.");
        cm.dispose();
