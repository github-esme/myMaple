...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
                ...
                cm.sendYesNo("If you use the regular coupon, your may end up with a random new look for your face...do you still want to do it using #b#t5152000##k?");
            }
        else if (status == 1){
            cm.dispose();
            if (cm.haveItem(5152000) == true){
                ...
                cm.sendOk("Hmm ...it looks like you don't have the coupon specifically for this place. The wrong coupon means no plastic surgery. Sorry!");
            }
        }
    }
}
