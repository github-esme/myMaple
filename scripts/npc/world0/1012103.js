...
/*
   Npc: Natalie
--------------------------------------
   Map: 100000104 - Victoria Road - Henesys Hair Salon
--------------------------------------
...
function action(mode, type, selection) {
    if (mode < 1) {
        ...
        status++;
        if (status == 0) 
            cm.sendSimple("I'm the head of this hair salon. If you have a #b#t5150001##k,#b#t5151001##k or #b#t5420002##k allow me to take care of your hairdo. Please choose the one you want.\r\n#L0##bHaircut(VIP coupon)#k#l\r\n#L1##bDye your hair(VIP coupon)#k#l\r\n#L2##bChange Hairstyle (VIP Membership Coupon)#k#l");
        else if (status == 1) {
            if (selection == 0) {
                beauty = 1;
                hairnew = Array();
