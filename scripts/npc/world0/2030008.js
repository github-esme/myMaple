        ...
        if (status == 1) {
            ...
            if (selection == 0) { //ZPQ
                ...
                if (teethmode == 2 && cm.haveItem(4031061) && cm.haveItem(4031062))
                    cm.sendYesNo("If you want more #v4001017#, you need to bring me the same 30 #v4000082#.  Turns out gold dentures don't last long, and I need a new one.\r\nDo you have those teeth for me?");
                else if (cm.haveItem(4031061) && cm.haveItem(4031062))
                    cm.sendYesNo("Okay, you've completed the earlier trials.  Now, with a little hard work I can get you the #bseeds of Zakum#k necessary to enter combat.  But first, my teeths are not as good as they used to be.  You ever seen a dentist in myMaple?  Well, I heard the Miner Zombies have gold teeth.  I'd like you to collect 30 #v4000082# so I can build myself some dentures.  Then I'll be able to get you the items you desire.\r\nRequired:\r\n#i4000082##b x 30");
                else {
            ...
            else if (selection == 3)
            {
                if (cm.getMeso() >= 50000000)
                {
                    if (cm.canHold(4001017))
                    {
                        ...
                        cm.sendOk("Here is your #v4001017# #t4001017#!");
                        cm.dispose();
                    }
                    else
                    {
