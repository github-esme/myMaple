...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        //     cm.dispose();
        // } else 
        if (player.getLevel() < zakum.getMinLevel() && player.getLevel() > zakum.getMaxLevel()) { //Don't fit requirement
            ...
            if (expedition.contains(player)) { //If you're registered, warp you in
                if (em.getInstance("ZakumBattle_" + player.getClient().getChannel()) != null)
                {
