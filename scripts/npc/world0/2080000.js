...
function action(mode, type, selection) {
    ...
    var options = new Array("What's a stimulator?","Create a Warrior weapon","Create a Bowman weapon","Create a Magician weapon","Create a Thief weapon","Create a Pirate Weapon",
        "Create a Warrior weapon with a Stimulator","Create a Bowman weapon with a Stimulator","Create a Magician weapon with a Stimulator","Create a Thief weapon with a Stimulator","Create a Pirate Weapon with a Stimulator", "Craft a Cornian's Dagger");
    ...
    cm.sendSimple(selStr);
        ...
        if (selectedType == 0) { //What's a stim?
            ...
            status = 3;
            cm.sendYesNo("Do you have the required items?\r\n\r\n#e1 #v4011001# #t4011001#\r\n1 #v4011002# #t4011002#\r\n1 #v4001079# #t4001079##n");
	    }
    } else if (status == 2) {
    ...
    {
        if(cm.hasItem(4011001) && cm.hasItem(4011002) && cm.hasItem(4001079))
        {
            ...
            cm.sendOk("You have crafted a #4001078# #t4001078#!");
            cm.dispose();
        }
        else
        {
