    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            if (cm.getPlayer().isIntern()) {
                ...
                cm.sendOk("#e This NPC is only for GM.");
                cm.dispose();
            }
        } else if (status == 1) {
            name = cm.getText(); 
