...
//** Warrior 3rd Job Instructor Tylus
...
function action(mode, type, selection){
    ...
    if (actionx["Mental"]){
        if (status == 0)
            ...
            cm.sendNext("You're #b" + jobTitle + "#k from here on out. Now go, with pride!");
        } else if (status == 3) {
        ...
        cm.sendOk("Go, talk with #b#p1022000##k and bring me #b#t4031057##k.");
        cm.dispose();
