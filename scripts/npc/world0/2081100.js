...
function action(mode, type, selection) {
    if (mode >= 1 && cm.getJobId() % 100 % 10 != 2) {
		...
		if(cm.getJobId() == 112) 
		{
			...
			if(cm.getPlayer().getSkillLevel(1121001) == 0)
				cm.teachSkill(1121001 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(1120004) == 0)
				cm.teachSkill(1120004 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(1121008) == 0)
		...
		else if(cm.getJobId() == 122) 
		{
			...
			if(cm.getPlayer().getSkillLevel(1221001) == 0)
				cm.teachSkill(1221001 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(1220005) == 0)
				cm.teachSkill(1220005 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(1221009) == 0)
		...
		else if(cm.getJobId() == 132) 
		{
			...
			if(cm.getPlayer().getSkillLevel(1321001) == 0)
				cm.teachSkill(1321001 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(1320005) == 0)
				cm.teachSkill(1320005 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(1321007) == 0)
