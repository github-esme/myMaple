...
function action(mode, type, selection) {
	if (mode >= 1 && cm.getJobId() % 100 % 10 != 2) {
		...
		if(cm.getJobId() == 312) 
		{
			...
			if(cm.getPlayer().getSkillLevel(3120005) == 0)
				cm.teachSkill(3120005 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(3121007) == 0)
		...
		else if(cm.getJobId() == 322) 
		{
			...
			if(cm.getPlayer().getSkillLevel(3221002) == 0)
				cm.teachSkill(3221002 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(3220004) == 0)
				cm.teachSkill(3220004 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(3221006) == 0)
