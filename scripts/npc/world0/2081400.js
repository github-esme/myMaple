...
function action(mode, type, selection) {
    if (mode >= 1 && cm.getJobId() % 100 % 10 != 2) {
		...
		if (cm.getJobId() == 412) 
		{
			...
			if(cm.getPlayer().getSkillLevel(4120002) == 0)
				cm.teachSkill(4120002 , 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(4120005) == 0)
		...
		else if (cm.getJobId() == 422) 
		{
			...
			if(cm.getPlayer().getSkillLevel(4220002) == 0)
				cm.teachSkill(4220002, 0, 10, -1);
			if(cm.getPlayer().getSkillLevel(4220005) == 0)
