...
function end(mode, type, selection) {
	...
	if (!qm.canHold(1142069)) {
	    ...
	    if (qm.getJob().getId() == 1111) {
		qm.changeJobById(1112);
	    } else if (qm.getJob().getId() == 1211) {
		qm.changeJobById(1212);
	    } else if (qm.getJob().getId() == 1311) {
		qm.changeJobById(1312);
	    } else if (qm.getJob().getId() == 1411) {
		qm.changeJobById(1412);
	    } else if (qm.getJob().getId() == 1511) {
		qm.changeJobById(1512);
	    }
	    qm.teachSkill(10001005, 1, 0, -1); //Echo
