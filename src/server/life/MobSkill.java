    ...
    public void applyEffect(MapleCharacter player, MapleMonster monster, boolean skill) {
        ...
        if (disease != null) {
            if (lt != null && rb != null && skill) {
                ...
                // Chaos Zakum
            } else if (player.getMapId() == 280030000 && player.getEventInstance() != null && player.getEventInstance().getProperty("chaos") != null && player.getEventInstance().getProperty("chaos").equals("true")) {
                Random rand = new Random();
                int randomNum = rand.nextInt((3 - 1) + 1) + 1;

                if (randomNum == 1) {
                    player.giveDebuff(MapleDisease.getType(128), MobSkillFactory.getMobSkill(128, 1), 3600000);
                } else {
                    player.giveDebuff(disease, this, true);
                }
            } else {
