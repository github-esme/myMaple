...
public class MapleGachapon {
    ...
    public enum Gachapon {
        ...
        HENESYS(9100100, 100, 8, 2, new Henesys()),
        ELLINIA(9100101, 100, 8, 2, new Ellinia()),
        PERION(9100102, 100, 8, 2, new Perion()),
        KERNING_CITY(9100103, 100, 8, 2, new KerningCity()),
        SLEEPYWOOD(9100104, 100, 8, 2, new Sleepywood()),
        MUSHROOM_SHRINE(9100105, 100, 8, 2, new MushroomShrine()),
        SHOWA_SPA_MALE(9100106, 100, 8, 2, new ShowaSpaMale()),
        SHOWA_SPA_FEMALE(9100107, 100, 8, 2, new ShowaSpaFemale()),
        NEW_LEAF_CITY(9100109, 100, 8, 2, new NewLeafCity()),
        NAUTILUS_HARBOR(9100117, 100, 8, 2, new NautilusHarbor());
