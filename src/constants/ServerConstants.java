...
public class ServerConstants {
    ...
    public static final boolean MULTI_LEVELING = true;
    public static boolean ENABLE_SMEGA = true;
    //Rates
    public static final int EXP_RATE = 4;
    public static final int MESO_RATE = 2;
    public static final int DROP_RATE = 2;
    public static final int QUEST_RATE = 6;
    public static final int BOSS_DROP_RATE = 2;
    public static final int PARTY_EXPERIENCE_MOD = 0; // change for event stuff
    public static final double PQ_BONUS_EXP_MOD = 0;
