                ...
                case 1: // Megaphone
                    if (player.getLevel() > 9) {
                        if (ServerConstants.ENABLE_SMEGA) {
                            ...
                            player.dropMessage(1, "You can not smega when you are muted.");
                        } else {
                            player.dropMessage(1, "All smegas have been disabled.");
                        }
                    } else {
...
//                        } else if (ii.isDropRestricted(item)) { //Lol?
...
//                        }
            ...
            if (!vip) {
                ...
                if (victim != null) {
                    ...
                    if ((victim.getMapId() < 270010100 || victim.getMapId() > 270030500) && (c.getChannelServer().getMapFactory().getMap(victim.getMapId()).getForcedReturnId() == 999999999 || victim.getMapId() < 100000000)) {
            ...
            for (byte i = 0; i < 3; i++) {
                ...
                if (pet != null) {
                    if (pet.canConsume(itemId) || (itemId == 5240006 && pet.getItemId() == 5000012)) {
                        pet.setFullness(100);
