                ...
                synchronized (mapitem) {
                    ...
                    if (mapitem.getMeso() > 0) {
                        ...
                        if (mapitem.getItemId() == 4031865) {
                            chr.message("You have picked up a 100 NX card. You have been credited 100 NX.");
                        } else if (mapitem.getItemId() == 4031866) {
                            chr.message("You have picked up a 250 NX card. You have been credited 250 NX.");
                        }
                    ...
                    if ((mapitem.getItemId() >= 5360000 && mapitem.getItemId() <= 5360008) || mapitem.getItemId() == 5360042 || mapitem.getItemId() == 5211000 || (mapitem.getItemId() >= 5211014 && mapitem.getItemId() <= 5211018) || mapitem.getItemId() == 5211039 || mapitem.getItemId() == 5211042 || mapitem.getItemId() == 5211045 || mapitem.getItemId() == 5211048) {
                        chr.setRates();
                    }
                }
            }
                    ...
                    for (MapleCharacter mc : c.getPlayer().getMap().getCharacters()) {
                        if (mc.getParty() == c.getPlayer().getParty()) {
                            switch (id) {
                                ...
                                case 2022160:
                                case 2022177:
                                    mc.setMp(mc.getMp() + 300);
                                    break;
                                case 2022161:
                                    mc.setHp(mc.getMaxHp() / 2);
                                    mc.setMp(mc.getMaxMp() / 2);

                                    if (mc.getParty() != null) {
                                        for (MaplePartyCharacter partyMembers : mc.getParty().getMembers()) {
                                            if (mc.getMapId() == partyMembers.getPlayer().getMapId()) {
                                                partyMembers.getPlayer().setHp(partyMembers.getPlayer().getMaxHp() / 2);
                                                partyMembers.getPlayer().setMp(partyMembers.getPlayer().getMaxMp() / 2);
                                            }
                                        }
                                    }
                                    break;
