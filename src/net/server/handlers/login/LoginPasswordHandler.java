...
public final class LoginPasswordHandler implements MaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (c.finishLogin() == 0) {
            if (c.getPasswordChange()) {
                c.announce(MaplePacketCreator.serverNotice(1, "Due to a recent security breach, you will have to change your password before you can log in. Please go to our website to change your password."));
            } else {
                login(c);
            }
        } else {
